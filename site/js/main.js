...
(function(){
  ...
  if(frames.length){
    if('IntersectionObserver' in window){
      ...
      frames.forEach(function(f){ f.classList.add('in-view'); });
    }
  }
  ...
  function openModal(frame){
    lastFocused = frame;
    document.getElementById('modalMedium').textContent = frame.getAttribute('data-medium').toUpperCase();
    document.getElementById('modalTitle').textContent = frame.getAttribute('data-title');
    document.getElementById('modalYear').textContent = frame.getAttribute('data-year');
    document.getElementById('modalTools').textContent = frame.getAttribute('data-tools');
    document.getElementById('modalDesc').textContent = frame.getAttribute('data-desc');
  ...
  if(overlay && dialog && closeBtn){
    frames.forEach(function(frame){
      frame.addEventListener('click', function(){ openModal(frame); });
    });
